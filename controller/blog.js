...
async function displayPosts(req, res) {
                ...
                <section>
                    ...
                    <div class="main">
                        ...
                        <div class="main_content">
                            <div class="main_content_adminbtns">
                                <button type="button" id="newpost-btn">New Post</button>                        
                            </div>
                            <div class="main_content_editor" hidden>
                                <form>
                                    <label for="title" class="main_content_editor_label">Title</label>
                                    <input type="text" name="title" id="post_title" class="main_content_editor_input" required>
                                    <br>
                                    <label for="body" class="main_content_editor_label">Body</label>
                                    <div class="main_content_editor_buttons">
                                        ...
                                        <button type="button">Hyperlink</button>
                                    </div>
                                    <textarea name="body" id="post_body" class="main_content_editor_textarea" required></textarea>
                                    <br>
                                    <button type="button" id="submit-post-btn" class="main_content_editor_btn">Publish</button>
                                </form>
                            </div>
    ...
    for (let r = 0; r < rows.length; r++) {
        ...
        const username = await userIDGetUsername(db, authorID);
        const pageID = row["ID"];
        const dateFormat = dateToStr(row["Date"]);

        html += `
            <div class="main_content_listing">
                <h1 class="main_content_listing_title"><a href="/blog/${pageID}">${title}</a></h1>
...
module.exports = { submitPost, showBlogPost, displayPosts };
